...
import cat.pilos.xupxup.finders.RecieptFinder;
...
public class RecieptActivity extends SherlockActivity implements OnNavigationListener{

	public static final String RECIPE_ID_EXTRA = "recipeId";
	private Reciept recipe;
	...
	private void setInitialUiData() {
		...
		RecieptFinder recFinder= new RecieptFinder(this);
