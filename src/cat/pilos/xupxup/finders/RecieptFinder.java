...
import cat.pilos.xupxup.model.Reciept;

public class RecieptFinder {
	
	private RecieptDBAdapter recipeDB;
	private Context baseContext;
	
	
	public RecieptFinder(Context baseContext){
	...
	public List<Reciept> getAllRecipes(){
	
		List<Reciept> recipeList= new ArrayList<Reciept>();
	...
	public Reciept getRecipeInfo(long recipeId){
		
		Reciept tmpReciept=null;
	...
	public List<Reciept> getAllRecipe(long recipeId){
